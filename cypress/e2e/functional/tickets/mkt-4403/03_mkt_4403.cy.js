...
/*
  ...
  NO VSU Upsell $97|$147 > 
  VSU Downsell $29 >
  Custom Diet Plan reup Cross-Sell Page $47 > 
...
describe('MKT-4403 Funnel Test', () => {
  ...
  it('03 Verify Funnel No CDP With No VSU Upsells', () => {

    const file = 'cypress/e2e/data/mkt-4403/03_mkt_4403_orders.json'
    ...
    // Save Order Details
    // cy.SaveOrderDetails(file, 'VSU ALL-ACCESS ANNUAL PASS', '1', '97.00', '0.00')
    ...
    // Save Order Details
    cy.SaveOrderDetails(user, file, 'VSU - Monthly - 29', '1', '29.00', 'digital')

    // Save Order Details  
    cy.SaveOrderDetails(user, file, 'VSU All-Access Bundle - Monthly $29', '1', '29.00', 'digital')
    ...
    // Save Order Details    
    cy.SaveOrderDetails(user, file, 'Silver Custom Diet Plan (4 Week Re-up)', '1', '47.00', 'digital')
