...
describe('MKT-4403 Funnel Test', () => {
  ...
  it('01 Verify Funnel No CDP With All Upsells', () => {

    const file = 'cypress/e2e/data/mkt-4403/01_mkt_4403_orders.json'
    ...
    // Save Order Details
    cy.SaveOrderDetails(user, file, 'VSU ALL-ACCESS ANNUAL PASS', '1', '97.00', 'digital')
