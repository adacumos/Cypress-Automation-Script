...
describe('MKT-4403 Funnel Test', () => {
  ...
  it('05 Verify Funnel No CDP With No VSU Upsells/Downsells', () => {

    const file = 'cypress/e2e/data/mkt-4403/05_mkt_4403_orders.json'
    ...
    // Save Order Details
    cy.SaveOrderDetails(user, file, 'MOVE 30', '1', '27.00', 'digital')
